    ...
    public class MethodFactory
    {
        ...
        public static void GenerateMethod(Type interfacetype, MethodInfo methodInfo, TypeBuilder typeBuilder)
        {
            ...
            if (InternalConfig.EmitTestCode)
            {
                ...
                methodILGenerator.Emit(OpCodes.Ldstr, "Lark4Net.Core.ProxyFactory.MethodFactory Info: ");
            ...
            methodILGenerator.Emit(OpCodes.Call, typeof(Lark.Core.InvokeProxy).GetMethod("Invoke",
